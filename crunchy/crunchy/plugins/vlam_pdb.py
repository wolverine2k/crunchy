...
from crunchy.interface import (config, plugin, SubElement, tostring, translate,
                           StringIO, python_version)
import crunchy.interface as interface
from crunchy.utilities import extract_log_id, unChangeHTMLspecialCharacters, escape_for_javascript
import crunchy.utilities as util
from crunchy.cometIO import raw_push_input, is_accept_input, write_output
import re, sys
...
pdb_pycode = '''
from crunchy.plugins.vlam_pdb import MyPdb,Proto
_debug_string = """%s
"""
mypdb = MyPdb()
