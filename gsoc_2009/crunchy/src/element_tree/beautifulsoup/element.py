...
class Tag(PageElement, Entities):
    ...
    def recursiveChildGenerator(self):
        if not len(self.contents):
            raise StopIteration
        # Modified to make building Crunchy to Python 3 easier.
        # BeautifulSoup has a modified build script that turns of the
        # "next" fixer (PEP 3114) for just this purpose, a luxury we
        # can't afford.
