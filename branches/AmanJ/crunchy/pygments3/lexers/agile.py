...
from pygments3.lexer import Lexer, RegexLexer, ExtendedRegexLexer, \
     LexerContext, include, combined, do_insertions, bygroups, using
from pygments3.token import Error, Text, \
     Comment, Operator, Keyword, Name, String, Number, Generic, Punctuation
from pygments3.util import get_bool_opt, get_list_opt, shebang_matches
from pygments3 import unistring as uni
...
# b/w compatibility
from pygments3.lexers.functional import SchemeLexer
...
class RubyLexer(ExtendedRegexLexer):
    ...
    tokens = {
        'root': [
            ...
            # better ideas?)
            # since pygments3 0.7 we also eat a "?" operator after numbers
...
class LuaLexer(RegexLexer):
    ...
    `disabled_modules`
        ...
        .. sourcecode:: pycon
            ...
            >>> from pygments3.lexers._luabuiltins import MODULES
            >>> MODULES.keys()
