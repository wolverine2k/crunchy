...
from pygments3.lexer import Lexer, LexerContext, RegexLexer, ExtendedRegexLexer, \
     bygroups, include, using, this, do_insertions
from pygments3.token import Punctuation, Text, Comment, Keyword, Name, String, \
     Generic, Operator, Number, Whitespace, Literal
from pygments3.util import get_bool_opt
from pygments3.lexers.other import BashLexer
...
class RstLexer(RegexLexer):
    ...
    *New in Pygments 0.7.*
    ...
    def _handle_sourcecode(self, match):
        from pygments3.lexers import get_lexer_by_name
...
class VimLexer(RegexLexer):
    ...
    *New in Pygments 0.8.*
    ...
    def __init__(self, **options):
        from pygments3.lexers._vimbuiltins import command, option, auto
        self._cmd = command
        self._opt = option
        self._aut = auto
