...
from crunchy.interface import config, u_print, translate, additional_vlam, accounts, python_version
...
trans_path = os.path.join(config['crunchy_base_dir'], "data", "translations")
trans_path2 = os.path.join(config['crunchy_base_dir'], "data", "server_root",
                                                          "edit_area", "langs")
