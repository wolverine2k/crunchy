...
from pygments3.util import docstring_headline

# start
from pygments3.formatters.bbcode import BBCodeFormatter
from pygments3.formatters.html import HtmlFormatter
from pygments3.formatters.img import BmpImageFormatter
from pygments3.formatters.img import GifImageFormatter
from pygments3.formatters.img import ImageFormatter
from pygments3.formatters.img import JpgImageFormatter
from pygments3.formatters.latex import LatexFormatter
from pygments3.formatters.other import NullFormatter
from pygments3.formatters.other import RawTokenFormatter
from pygments3.formatters.rtf import RtfFormatter
from pygments3.formatters.svg import SvgFormatter
from pygments3.formatters.terminal import TerminalFormatter
from pygments3.formatters.terminal256 import Terminal256Formatter

FORMATTERS = {
    BBCodeFormatter: ('BBCode', ('bbcode', 'bb'), (), 'Format tokens with BBcodes. These formatting codes are used by many bulletin boards, so you can highlight your sourcecode with pygments3 before posting it there.'),
...
if __name__ == '__main__':
    ...
    for filename in os.listdir('.'):
        if filename.endswith('.py') and not filename.startswith('_'):
            module_name = 'pygments3.formatters.%s' % filename[:-3]
            print(module_name)
