...
from pygments3.plugin import find_plugin_lexers
from pygments3.util import ClassNotFound, bytes
...
def guess_lexer_for_filename(_fn, _text, **options):
    ...
    usage::
        ...
        >>> from pygments3.lexers import guess_lexer_for_filename
        >>> guess_lexer_for_filename('hello.html', '<%= @foo %>')
        <pygments3.lexers.templates.RhtmlLexer object at 0xb7d2f32c>
        >>> guess_lexer_for_filename('hello.html', '<h1>{{ title|e }}</h1>')
        <pygments3.lexers.templates.HtmlDjangoLexer object at 0xb7d2f2ac>
        >>> guess_lexer_for_filename('style.css', 'a { color: <?= $link ?> }')
        <pygments3.lexers.templates.CssPhpLexer object at 0xb7ba518c>
    """
    fn = basename(_fn)
    primary = None
    matching_lexers = set()
...
import sys
oldmod = sys.modules['pygments3.lexers']
newmod = _automodule('pygments3.lexers')
newmod.__dict__.update(oldmod.__dict__)
sys.modules['pygments3.lexers'] = newmod
