...
from interp_backend import fixLineEnding
...
def run(id, code):
    ...
    if 'plot' in id:
        ...
        __dict =  {_('circle'): __g.circle,
                ...
                _('point'): __g.point}
    graph_dict = dict(__dict, **soundout.all_sounds)
    try:
...
class Plot(Graphics):
    ...
    def plot_function(self, fn):
        nb_points = self.width - 2*self.x_axis_offset*self.x_scale - 1
    ...
    if hex_code.match(colour):
        ...
        try:
            ...
            if r >= 0 and r <= 255 and g >= 0 and g <= 255 and b >= 0 and b <= 255:
                ...
                raise errorhandler.ColourNameError(colour)
        except:
            raise errorhandler.ColourNameError(colour)
