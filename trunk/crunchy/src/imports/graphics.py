...
def init(width=400, height=400, border_color='red', origin = 'top'):
...
def _circle(centre, r, filled=False):
    '''
...
def _rectangle(corner, w, h, filled=False):
...
def _triangle(point_1, point_2, point_3, filled=False):
    '''
