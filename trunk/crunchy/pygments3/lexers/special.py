...
from pygments3.lexer import Lexer
from pygments3.token import Token, Error, Text
from pygments3.util import get_choice_opt, b
...
class RawTokenLexer(Lexer):
    ...
    aliases = ['raw']
    filenames = []
    mimetypes = ['application/x-pygments3-tokens']
