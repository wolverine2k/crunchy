...
import re
from pygments3.token import String, Comment, Keyword, Name, Error, Whitespace, \
    string_to_tokentype
from pygments3.filter import Filter
from pygments3.util import get_list_opt, get_int_opt, get_bool_opt, get_choice_opt, \
     ClassNotFound, OptionError
from pygments3.plugin import find_plugin_filters
...
class RaiseOnErrorTokenFilter(Filter):
    ...
    `excclass` : Exception class
      ...
      The default is `pygments3.filters.ErrorToken`.
